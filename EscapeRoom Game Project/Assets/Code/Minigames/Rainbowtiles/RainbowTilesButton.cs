...
public class RainbowTilesButton : MonoBehaviour
{
    ...
    /// <summary>
    /// Iterates through each colour when the player clicks on it
    /// </summary>
    ...
    /// <summary>
    /// Scales the object down and then back to full size for a click effect
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Sets the material to the current colour of the button
    /// </summary>
    void ChangeColour()
    {
